...
public class ProjectRepositoryImpl implements ProjectRepository {
    ...
    public ProjectRepositoryImpl() {
        ...
        try {
            ...
            projects.add(new Project(2, "Dự án mở kênh đào Hormuz", "Chúng tôi rất quan ngại nếu không mở", "Đỗ Nam Trung", sdf.parse("01/03/2026"), sdf.parse("30/04/2026"), 2));
            ...
            throw new IllegalStateException("Cannot initialize hard-coded project data", e);
        }
    }
    ...
    @Override
    public Project findById(int prjId) {
        return projects.stream()
                .filter(project -> project.getPrjId() == prjId)
                .findFirst()
                .orElse(null);
    }
}
